      ...
      >
        {staticTipValues.map((tip) => (
          <ToggleButton
            ...
            id={tip}
            className={twJoin(
              "h-12 cursor-pointer outline-0 px-4 py-2 bg-green-900 text-white font-bold text-2xl rounded-sm transition-all duration-200",
    ...
    >
      <Input
        ...
        className={twJoin(
          ...
          "focus:outline-2 focus:outline-green-400 focus:outline-offset-2 hover:outline-2 hover:outline-green-200 hover:outline-offset-2",
